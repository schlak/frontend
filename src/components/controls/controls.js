...
import { shuffleToggle } from "../../store/actionCreators";

function Controls() {
    const dispatch = useDispatch();

    const isShuffle = useSelector((state) => state.session.actions.shuffle);
    ...
    return (
        <div className="controls">
            <div className={`control-button shuffle${isShuffle ? " selected" : ""}`} onClick={handleShuffleToggle}>
