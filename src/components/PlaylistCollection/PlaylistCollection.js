...
import { filterTracks, groupTracksIntoAlbums, groupTracksIntoPlaylists } from "../../utils/sortTracks";
...
function TrackList() {
    ...
    let albumsBeingRendered = groupTracksIntoPlaylists(trackStore.data, tracksFiltered).map((data, key) => {
        return <Playlist playlist={data} key={key} />;
    });
